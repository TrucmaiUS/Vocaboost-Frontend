        ...
        <div className="main-page">
            ...
            <div className="boxes">
                <div className="boxes-fill-in-blank">
                    ...
                    <div className="content">Learn new words by actively using them in context.<br />
                        Train your brain to recognize how and where a word is used.</div>
                </div>

                <div className="boxes-flashcard">
                    <h1>Flashcard</h1>
                    <img src={Vector} alt="Vector" />
                    <div className="content">Fast-paced review with visuals and examples. <br /> Flip, remember, and repeat
                        — the classic made smarter.</div>
                </div>
                ...
                <div className="boxes-word-association">
                    ...
                    <div className="content">
                        Boost your vocabulary by learning new words. <br /> Link them with related ideas, images, or concepts.
                    </div>
                </div>
            </div>
